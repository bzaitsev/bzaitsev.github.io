...
module.exports = ".app-root {\r\n  font-family: helvetica, sans-serif;\r\n  border: 1px solid #ccc;\r\n  padding-bottom: 10px;\r\n}\r\n.app-head {\r\n  display: flex;\r\n  justify-content: space-between;\r\n}\r\n.app-side-paddings {\r\n  padding-left: 10px;\r\n  padding-right: 10px;\r\n}\r\n.app-head,\r\n.app-parameters {\r\n  padding: 10px;\r\n  background-color: #ddd;\r\n}\r\n.app-parameters {\r\n  margin-bottom: 20px;\r\n}\r\n.app-data-block {\r\n  padding-top: 15px;\r\n  padding-bottom: 10px;\r\n}\r\n.app-searchfield {\r\n  padding: 5px;\r\n}\r\n.icon-weather-status {\r\n  max-height: 1.8em;\r\n  vertical-align: middle;\r\n}\r\n.app-center-text {\r\n  text-align: center;\r\n}\r\n.app-temperature {\r\n  font-size: 25px;\r\n}\r\n.app-weather-status {\r\n  font-size: 14px;\r\n}\r\n.app-parameter {\r\n  display: inline-block;\r\n}\r\n.app-parameter:not(:first-of-type) {\r\n  margin-left: 15px;\r\n}\r\n.app-footer {\r\n  margin-top: 30px;\r\n  font-size: 14px;\r\n  text-align: center;\r\n}\r\n.app-footer .angular-logo {\r\n  width: 15px;\r\n  vertical-align: text-bottom;\r\n}\r\n.app-toolbar {\r\n  margin: 20px 0 0 0;\r\n}\r\n.app-toolbar button {\r\n  background-color: #f6f6f6;\r\n  border: 1px solid #ccc;\r\n  line-height: 30px;\r\n  padding: 0px 10px;\r\n  cursor: pointer;\r\n  outline: none;\r\n}\r\n.app-toolbar button:not(:first-of-type) {\r\n  border-left-width: 0;\r\n}\r\n.app-toolbar :hover {\r\n  background-color: #eee;\r\n}\r\n.app-toolbar .active,\r\n.app-toolbar .active:hover {\r\n  background-color: #ddd;\r\n}\r\n"
...
module.exports = "<div class=\"app-root\">\n  <simple-notifications></simple-notifications>\n\n  <div class=\"app-head\">\n    <div>\n      <img [src]=\"iconUrl\" alt=\"\" class=\"icon-weather-status\">\n      Forecast\n    </div>\n    <input #searchfield (keyup.enter)=\"onSearchEnter(searchfield.value)\" type=\"search\" class=\"app-searchfield\" id=\"city-searchfield\" placeholder=\"City\">\n  </div>\n\n  <div class=\"app-data-block app-side-paddings\">\n    <div>{{detailedWeather.dt_txt | date:'EEEE, d MMMM'}}</div>\n    <div class=\"app-center-text\">\n      <div class=\"app-location\">\n        {{allWeather.city.name}}, {{allWeather.city.country}}\n      </div>\n\n      <div class=\"app-temperature\">\n        {{detailedWeather.main.temp | number: '1.0-0'}}&deg;C\n      </div>\n\n      <div class=\"app-weather-status\">\n        <img [src]=\"iconUrl\" alt=\"\" class=\"icon-weather-status\">\n        {{weatherStatus}}\n      </div>\n    </div>\n  </div>\n\n  <div class=\"app-center-text app-parameters\">\n    <strong class=\"app-parameter\">Pressure:</strong> {{detailedWeather.main.pressure | number: '1.0-0'}} hPa\n    <strong class=\"app-parameter\">Humidity:</strong> {{detailedWeather.main.humidity}}%\n    <strong class=\"app-parameter\">Wind Speed:</strong> {{detailedWeather.wind.speed | number: '1.0-1'}} m/s\n    <strong class=\"app-parameter\">Clouds:</strong> {{detailedWeather.clouds.all}}%\n  </div>\n\n  <div class=\"app-side-paddings\">\n    3 hour forecast ({{allWeather.cnt}} intervals shown)\n\n    <div class=\"app-toolbar\" (click)=\"onToolbarClick($event)\">\n      <button data-type=\"temperature\" [ngClass]=\"{ active: chartParam == 'temperature'}\">Temperature</button>\n      <button data-type=\"pressure\" [ngClass]=\"{ active: chartParam == 'pressure'}\">Pressure</button>\n      <button data-type=\"wind\" [ngClass]=\"{ active: chartParam == 'wind'}\">Wind</button>\n      <button data-type=\"humidity\" [ngClass]=\"{ active: chartParam == 'humidity'}\">Humidity</button>\n    </div>\n\n    <app-chart [options]=\"chartOptions\"></app-chart>\n  </div>\n</div>\n\n<footer class=\"app-footer\">\n  <img src=\"favicon.ico\" class=\"angular-logo\"> Angular 6, Weather Forecast Application.\n</footer>\n"
...
var AppComponent = /** @class */ (function () {
    function AppComponent(weatherService, notificationsService) {
        ...
        this.chartParam = 'temperature';
        this.getWeather('London');
    }
    AppComponent.prototype.onSearchEnter = function (city) {
        this.disableCitySearchField();
        this.getWeather(city);
    };
    AppComponent.prototype.onToolbarClick = function (event) {
    ...
    AppComponent.prototype.disableCitySearchField = function (value) {
        if (value === void 0) { value = true; }
        var citySearchField = document.getElementById('city-searchfield');
        if (!citySearchField)
            return;
        if (value) {
    ...
    AppComponent.prototype.getChartOptions = function (type) {
        var data = {};
        if (type) {
        ...
        data.labels = this.allWeather.list.map(function (item) {
    ...
    AppComponent.prototype.getTemperatureData = function () {
        var chartData = this.allWeather.list.map(function (item) {
    ...
    AppComponent.prototype.getPressureData = function () {
        var chartData = this.allWeather.list.map(function (item) {
    ...
    AppComponent.prototype.getWindData = function () {
        var chartData = this.allWeather.list.map(function (item) {
    ...
    AppComponent.prototype.getHumidityData = function () {
        var chartData = this.allWeather.list.map(function (item) {
    ...
    AppComponent.prototype.getWeather = function (city) {
        var _this = this;
        this.weatherService.getWeather(city).subscribe(function (response) {
            _this.disableCitySearchField(false);
            if (!response || !response.json) {
                return _this.notificationsService.error('Error', 'Server error.');
            }
            var data = response.json();
            if (+data.cod !== 200) {
                return _this.notificationsService.error('Error', data.cod + " " + data.message);
            }
            // set data
            ...
            if (_this.firstLoad) {
                ...
                _this.notificationsService.success('Loaded Forecast', _this.allWeather.city.name + ", " + _this.allWeather.city.country);
            }
            _this.chartOptions = _this.getChartOptions(_this.chartParam);
        }, function (error) {
            var data = error.json();
            _this.disableCitySearchField(false);
            return _this.notificationsService.error("Error " + data.cod, data.message);
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            imports: [
                ...
                angular2_notifications__WEBPACK_IMPORTED_MODULE_4__["SimpleNotificationsModule"].forRoot({
...
module.exports = ".app-chart-container {\r\n  position: relative;\r\n  width: 100%;\r\n  height: 500px;\r\n}\r\n"
...
module.exports = "<div class=\"app-chart-container\">\r\n  <canvas id=\"app-weather-chart\"></canvas>\r\n</div>\r\n"
...
var ChartComponent = /** @class */ (function () {
    ...
    ChartComponent.prototype.ngOnInit = function () {
        ...
        this.chart = new chart_js__WEBPACK_IMPORTED_MODULE_1__["Chart"]('app-weather-chart', defaultOptions);
    };
    ChartComponent.prototype.ngOnChanges = function (changes) {
        var options = changes.options, dataset;
...
module.exports = __webpack_require__(/*! D:\local_projects\rest\angular-app\src\main.ts */"./src/main.ts");
